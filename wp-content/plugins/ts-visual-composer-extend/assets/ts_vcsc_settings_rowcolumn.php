...
<div id="ts-settings-rowcolumn" class="tab-content">
	<?php if ((($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_PluginExtended == "true") && (get_option('ts_vcsc_extend_settings_additions', 1) == 1)) || (($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_PluginExtended == "false"))) { ?>
		<div class="ts-vcsc-section-main">
			...
			<div class="ts-vcsc-section-content">
				<div class="ts-vcsc-notice-field ts-vcsc-success" style="margin-top: 10px; font-size: 13px; text-align: justify;">
					"Composium - Visual Composer Extensions" allows you to extend the available options for Row and Column settings, adding features such as viewport animations (row + column) and a variety of background effects (row). If you already use other
        ...
        <div class="ts-vcsc-section-main">
			<div class="ts-vcsc-section-title ts-vcsc-section-show"><i class="dashicons-editor-kitchensink"></i>Extended Row Options</div>
			<div class="ts-vcsc-section-content">
				<div class="ts-vcsc-notice-field ts-vcsc-warning" style="margin-top: 20px; font-size: 13px; text-align: justify;">
					The amount of available additional options for row settings is very extensive and can slow down the rendering of the row settings panel in Visual Composer, particularly, if all availanle options are utilized. The controls below
                    allow you to easily define your custom set of additional row options, which can significantly decrease the rendering time for the row settings panel in Visual Composer, particularly, if only a few options are added.
				</div>
				...
				<div id="ts_vcsc_extend_settings_additionsRows_true" style="margin-top: 30px; margin-bottom: 10px; margin-left: 25px; <?php echo ($ts_vcsc_extend_settings_additionsRows == 0 ? 'display: none;' : 'display: block;'); ?>">
					<div id="ts_vcsc_extend_settings_rowAllowableOptionsWrap" class="ts-multiselect-holder" style="display: block; height: auto; margin: 20px 0 10px 0;">
						<h2>Enable Row Option Groups:</h2>
						<div class="ts-vcsc-notice-field ts-vcsc-warning" style="margin-top: 20px; font-size: 13px; text-align: justify;">
						...
						<select id="ts_vcsc_extend_settings_rowAllowableOptionsSelect" name="ts_vcsc_extend_settings_rowAllowableOptionsSelect" multiple="multiple" class="ts-multiple-options-selector" data-type="main" data-callback="rowoptions" data-holder="ts_vcsc_extend_settings_rowAllowableOptionsValue">
							<option value="globals" <?php selected($TS_VCSC_RowGlobalEnabled, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalEnabled; ?>">General Row Settings</option>
							<option value="backgrounds" <?php selected($TS_VCSC_RowBackgroundEnabled, "true"); ?> data-initial="<?php echo $TS_VCSC_RowBackgroundEnabled; ?>">Row Backgrounds</option>							
							<option value="effects" <?php selected($TS_VCSC_RowEffectEnabled, "true"); ?> data-initial="<?php echo $TS_VCSC_RowEffectEnabled; ?>">Row Effects</option>
						</select>
					</div>
					<div id="ts_vcsc_extend_settings_rowAllowableGlobalsWrap" class="ts-multiselect-holder" style="display: block; height: auto; margin: 10px 0 10px 0; border: 1px solid #ededed; padding: 10px 20px; background: #f9f9f9;">
						<h2>Enable General Row Options:</h2>
						...
						<select id="ts_vcsc_extend_settings_rowAllowableGlobalsSelect" name="ts_vcsc_extend_settings_rowAllowableGlobalsSelect" multiple="multiple" class="ts-multiple-options-selector" data-type="conditional" data-callback="globaloptions" data-holder="ts_vcsc_extend_settings_rowAllowableGlobalsValue">
							<option value="rowheight" <?php selected($TS_VCSC_RowGlobalRowheight, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalRowheight; ?>">Row Height Settings</option>
							<option value="rowwidth" <?php selected($TS_VCSC_RowGlobalRowwidth, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalRowwidth; ?>">Row Full Width Settings</option>
							<option value="visibility" <?php selected($TS_VCSC_RowGlobalVisibility, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalVisibility; ?>">Row Visibility Settings</option>
							<option value="viewport" <?php selected($TS_VCSC_RowGlobalViewport, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalViewport; ?>">Row Viewport Animation</option>
							<option value="columnheight" <?php selected($TS_VCSC_RowGlobalColumnheight, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalColumnheight; ?>">Row Columns Equalizier</option>
							<option value="general" <?php selected($TS_VCSC_RowGlobalGeneral, "true"); ?> data-initial="<?php echo $TS_VCSC_RowGlobalGeneral; ?>">Other General Row Settings</option>
						</select>
					...
					<div id="ts_vcsc_extend_settings_rowAllowableBackgroundsWrap" class="ts-multiselect-holder" style="display: block; height: auto; margin: 20px 0 10px 0; border: 1px solid #ededed; padding: 10px 20px; background: #f9f9f9;">
						<h2>Enable Individual Row Background Types:</h2>
						...
						<div id="ts_vcsc_extend_settings_rowAllowableBreakpointWrap" class="" style="display: block; width: 100%; margin: 20px 0 0 0;">
							<h3>Define Breakpoint for Row Backgrounds:</h3>
					...
					<div id="ts_vcsc_extend_settings_rowAllowableEffectsWrap" class="ts-multiselect-holder" style="display: block; height: auto; margin: 20px 0 10px 0; border: 1px solid #ededed; padding: 10px 20px; background: #f9f9f9;">
						<h2>Enable Additional Row Effect Options:</h2>
						...
						<select id="ts_vcsc_extend_settings_rowAllowableEffectsSelect" name="ts_vcsc_extend_settings_rowAllowableEffectsSelect" multiple="multiple" class="ts-multiple-options-selector" data-type="conditional" data-callback="" data-holder="ts_vcsc_extend_settings_rowAllowableEffectsValue">
							<option value="seperators" <?php selected($TS_VCSC_RowEffectSeperators, "true"); ?> data-initial="<?php echo $TS_VCSC_RowEffectSeperators; ?>">Row Seperators / Shapes</option>
