	...
	<div class="wrapper ts-vcsc-settings-group-container">		
		...
		<div id="v-nav" class="ts-vcsc-settings-group-tabs">
			<ul id="v-nav-main" data-type="settings">
				...
				<li id="link-ts-settings-rowcolumn"		data-tab="ts-settings-rowcolumn"		data-order="6"		data-name="Rows & Columns"	class="link-data"><i class="dashicons-editor-kitchensink"></i>Rows & Columns<span id="errorTab6" class="errorMarker"></span></li>
				<?php
					if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_CustomPostTypesCheckup == "true") {
